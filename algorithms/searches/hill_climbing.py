...
if __name__ == "__main__":
    ...
    print(f"The minimum score for f(x, y) = x^2 + y^2 found via hill climbing: {local_min.score()}")
    ...
    print(f"The maximum score for f(x, y) = x^2 + y^2 found via hill climbing: {local_min.score()}")
