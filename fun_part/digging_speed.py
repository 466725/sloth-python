...
personB = int(
    input("How many days does it take for person number 2 to finish digging( choose a number)?:")
)
personC = int(
    input("How many days does it take for person number 3 to finish digging( choose a number)?:")
)
