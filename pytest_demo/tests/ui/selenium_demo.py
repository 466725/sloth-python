"""
selenium_demo script to open Google in a maximized Chrome window and wait for 5 seconds before closing.
...
# Create WebDriver (selenium_demo 4.6+ auto-manages driver)
...
inputEle.send_keys("selenium_demo")
inputEle.submit()
