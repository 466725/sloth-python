...
- A Doubly Linked List (DLL) contains an extra pointer, typically called previous pointer, together with next pointer and metadata which are there in singly linked list.
